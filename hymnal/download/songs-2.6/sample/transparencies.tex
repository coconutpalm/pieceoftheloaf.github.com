...
% Set penalties so that as many verses and choruses are placed on a
% page as possible.
\vvpenalty=-100
\cvpenalty=-100
\vcpenalty=-100
...
{
  \makeatletter
  \gdef\@oddhead{{\sffamily\hfil\firstmark}}
  \global\let\@evenhead=\@oddhead
}
\renewcommand{\songmark}{\mark{\songnumstyle{songnum}}}
\renewcommand{\versemark}{\mark{\songnumstyle{songnum}. \ignorespaces\songtitle\unskip}}
\renewcommand{\chorusmark}{\mark{\songnumstyle{songnum}. \ignorespaces\songtitle\unskip}}

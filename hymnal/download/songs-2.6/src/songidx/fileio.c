 ...
 *   Read a line of output into <buffer>, which should be at least MAXLINELEN wide-
 *   characters in size. If the line is too long to fit into the buffer, close the file
 *   and report an error. Eliminate the trailing \n from the returned line. Return 1 on
 *   success or end-of-line, or 0 on failure. If end-of-line, set <eof flag> to 1.
 */
int

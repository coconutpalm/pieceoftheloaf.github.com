 ...
 *   num: a string representing the song's number in the book (might be something like "H10")
 *   linkname: a string denoting the internal hyperlink label for this song
 *   idx: a unique integer key that should be used to sort songs with identical titles
 */
typedef struct
{
	WCHAR *title;
